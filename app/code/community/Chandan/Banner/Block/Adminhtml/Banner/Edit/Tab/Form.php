<?php
class Chandan_Banner_Block_Adminhtml_Banner_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addType('image', 'Chandan_Banner_Block_Adminhtml_Banner_Edit_Tab_Image');
		...
		$fieldset->addField('buynow', 'select', array(
          'label'     => Mage::helper('banner')->__('Buy Now Link'),
          'name'      => 'buynow',
          'values'    => array(
              array(
                  'value'     => 1,
