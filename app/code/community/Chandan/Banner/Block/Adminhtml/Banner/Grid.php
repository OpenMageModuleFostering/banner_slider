<?php
class Chandan_Banner_Block_Adminhtml_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('filename', array(
			...
			'filter'    => false,
			'sortable'  => false,
			'renderer'	=> 'Chandan_Banner_Block_Adminhtml_Banner_Image',
		));
	  
	   
		$this->addColumn('content', array(
			'header'    => Mage::helper('banner')->__('Banner Content'),			
			 'width'     => '300px',
			'index'     => 'content',
